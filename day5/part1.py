...
# Perform a rule check on an individual update and return the middle page number if it passes.
def check_update(rules: list[tuple[int, int]], update: list[int]) -> int:
    page: int = 0
